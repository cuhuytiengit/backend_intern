    ...
    <body>
        ...
        <script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
            ...
            <div class="containers">
                    <div class="row">
                        <div class="col-12">
                            <div class="menu-sub container-fluid">
                                <div class="menu_way_new_for_2017 container-lg">
                                        <ul>
                                                ...
                                                <li><a href='http://localhost:8080/backend_intern/index.php/home/organics'>ORGANICS</a></li>
                                        </ul>
                                </div>
                            </div>
                        </div>
...
<div class="button-apply-clear container-lg">

        <button class = 'col-12 col-sm-12 col-md-5 col-lg-5'>APPLY</button>

        <button class = 'col-12 col-sm-12 col-md-5 col-lg-5'>CLEAR</button>
...
<?php  include 'organics_products.php'  ?>
