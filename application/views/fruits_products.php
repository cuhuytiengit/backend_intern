<?php
    ...
    $sql = "SELECT COUNT(*) AS id FROM products where id_category=4   " . ((strlen($oderBySql) > 0 ) ? $oderBySql :'' );
   ...
   $numPage = floor($totalUser['id']/$pageSize) + 1;
    ...
    $sql = "SELECT * FROM products where id_category=4  "  .  ((strlen($oderBySql) > 0 ) ? $oderBySql : "")  . " LIMIT " . ($page - 1)*$pageSize . ", " . $pageSize;
    ...
    include 'fruits_product_list.php';
