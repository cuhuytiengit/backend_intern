<?php
    ...
    $sql = "SELECT COUNT(*) AS id FROM products  where id_category=5 " . ((strlen($oderBySql) > 0 ) ? $oderBySql :'' );
   ...
   $numPage = floor($totalUser['id']/$pageSize) + 1;
    ...
    $sql = "SELECT * FROM products where id_category=5  "  .  ((strlen($oderBySql) > 0 ) ? $oderBySql : "")  . " LIMIT " . ($page - 1)*$pageSize . ", " . $pageSize;
    ...
    include 'organics_product_list.php';
